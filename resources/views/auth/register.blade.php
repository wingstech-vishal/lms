                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" id="registerForm">
                        ...
                        <div class="p-4">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Age</label>
                                <input type="text" class="form-control form-control-sm" placeholder="Age" value="@if(!empty($name)){{ $age }}@else{{ old('age') }}@endif" name="age">
                                @if ($errors->has('age'))
                                <label class="error" for="age">{{ $errors->first('age') }}</label>
                                @endif
                            </div>
                             <div class="form-group">
                                <label>Phone</label>
                                <input type="text" class="form-control form-control-sm" placeholder="Phone" value="@if(!empty($name)){{ $phone }}@else{{ old('phone') }}@endif" name="phone">
                                @if ($errors->has('phone'))
                                <label class="error" for="email">{{ $errors->first('phone') }}</label>
                                @endif
                            </div>
                            <div class="form-group">
